...
`TAMRANK_WORKFLOW_PREVIEW=1` explicitly selects development reads. The matching
...
The other five core names and seven specialist names currently refuse requests;
their presence is not a working write/scan/history implementation. Phase 4 is open.
...
- Core tools/list: 6316 compact characters at this read-only stage. Writer schemas
  will require a fresh surface-budget test.
