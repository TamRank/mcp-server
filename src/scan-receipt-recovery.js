...
const settlement=context.extend({client_request_id:request,expected_review_hash:hash,confirmed:z.literal(true)}).strict();
...
const reviewSchema=z.object({contract_version:z.literal(2),view:z.literal('result_settlement_review'),execution_id:uuid,
  ...
  execution_enabled:z.literal(false),provider_requested_this_call:z.literal(false),automatic_retry_allowed:z.literal(false)}).strict();
