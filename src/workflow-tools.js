...
export function workflowDefinitions() {
  return {
    ...
    diagnose_page: { description: 'Targeted stored facts and uncertainty, including device-bound PageSpeed lab evidence. Never starts scans.', schema: { post_id: pageId, section: z.enum(['overview','metadata','gsc','index','pagespeed']).optional() }, path: a => `/pages/${a.post_id}/diagnosis`, omit: ['post_id'] },
